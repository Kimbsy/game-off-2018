...
game_state = {
    ...
    # 'active_sprite1': None,
    # 'active_sprite2': None,
    'active_sprite1': os.getcwd() + '/data/pixel-components/pixel-glove.png',
    'active_sprite2': os.getcwd() + '/data/pixel-components/pixel-mug.png',
    'crop_sprite': None,
